      ...
      DO jn = 1, kjpt                                 !  tracer loop  !
         ...
         IF(  ( cdtype == 'TRA' .AND. ( jn == jp_tem .OR. ( jn == jp_sal .AND. lk_zdfddm ) ) ) .OR.   &
            ...
            DO jk = 1, jpkm1
               DO jj = 2, jpjm1
                  DO ji = 2, jpim1   ! vector opt.
                     ze3ta =  ( 1. - r_vvl ) +        r_vvl   * e3t(ji,jj,jk)   ! after scale factor at T-point
                     ze3tn =         r_vvl   + ( 1. - r_vvl ) * e3t(ji,jj,jk)   ! now   scale factor at T-point
         ...
         DO jj = 2, jpjm1
            DO ji = 2, jpim1
               ze3tb = ( 1. - r_vvl ) + r_vvl * e3t(ji,jj,1)
               ze3tn = ( 1. - r_vvl ) + r_vvl * e3t(ji,jj,1)
         ...
         DO jk = 2, jpkm1
            DO jj = 2, jpjm1
               DO ji = 2, jpim1
                  ze3tb = ( 1. - r_vvl ) + r_vvl * e3t(ji,jj,jk)
                  ze3tn = ( 1. - r_vvl ) + r_vvl * e3t(ji,jj,jk)
