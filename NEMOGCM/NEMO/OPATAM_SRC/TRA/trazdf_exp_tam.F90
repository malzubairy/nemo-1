            ...
            DO jk = 2, jpk
               DO jj = 2, jpjm1
                  DO ji = fs_2, fs_jpim1   ! vector opt.
                     ...
                     ELSE
                        zwytl(ji,jj,jk) = fsavs(ji,jj,jk) * ( zwxtl(ji,jj,jk-1) - zwxtl(ji,jj,jk) ) * zave3r
                     END IF
                  END DO
               END DO
            END DO
            ...
            DO jk = jpk, 2, -1
               DO jj = 2, jpjm1
                  DO ji = fs_2, fs_jpim1   ! vector opt.
                     ...
                     ELSE
                        zwxad(ji,jj,jk-1) = zwxad(ji,jj,jk-1) + fsavs(ji,jj,jk) * zwyad(ji,jj,jk) * zave3r
                        zwxad(ji,jj,jk  ) = zwxad(ji,jj,jk  ) - fsavs(ji,jj,jk) * zwyad(ji,jj,jk) * zave3r
                        zwyad(ji,jj,jk  ) = 0.0_wp
                     ENDIF
                  END DO
               END DO
...
#if defined key_obc
         & ztb_tlout, zsb_tlout, ztb_adin, zsb_adin,  &
#endif
...
#if defined key_obc
      ALLOCATE( ztb_tlout(jpi,jpj,jpk),  zsb_tlout(jpi,jpj,jpk),     &
           &    ztb_adin (jpi,jpj,jpk),  zsb_adin (jpi,jpj,jpk) )
#endif
...
#if defined key_obc
      zsp1 = zsp1 + DOT_PRODUCT( ztb_tlout, ztb_adin ) &
           &      + DOT_PRODUCT( zsb_tlout, zsb_adin )
#endif
